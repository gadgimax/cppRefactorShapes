    ...
    public class DataTests
    {
        ...
        public void TestResumenListaVacia()
        {
            ClassicAssert.AreEqual("<h1>Lista vacía de formas!</h1>",
                ReportBuilder.Imprimir(FormaResumenBuilder.CalcularResumen(new List<IFormaGeometrica>()), new Castellano()));
        }
        ...
        public void TestResumenListaVaciaFormasEnIngles()
        {
            ClassicAssert.AreEqual("<h1>Empty list of shapes!</h1>",
                ReportBuilder.Imprimir(FormaResumenBuilder.CalcularResumen(new List<IFormaGeometrica>()), new Ingles()));
        }
        ...
        public void TestResumenListaVaciaFormasEnItaliano()
        {
            ClassicAssert.AreEqual("<h1>Lista vuota di forme!</h1>",
                ReportBuilder.Imprimir(FormaResumenBuilder.CalcularResumen(new List<IFormaGeometrica>()), new Italiano()));
        }
        ...
        public void TestResumenListaConUnCuadrado()
        {
            ...
            var resumen = ReportBuilder.Imprimir(FormaResumenBuilder.CalcularResumen(cuadrados), new Castellano());
        ...
        public void TestResumenListaConUnCirculo()
        {
            ...
            var resumen = ReportBuilder.Imprimir(FormaResumenBuilder.CalcularResumen(circulos), new Castellano());
        ...
        public void TestResumenListaConUnTrapecio()
        {
            ...
            var resumen = ReportBuilder.Imprimir(FormaResumenBuilder.CalcularResumen(trapecio), new Castellano());
        ...
        public void TestResumenListaConMasCuadrados()
        {
            ...
            var resumen = ReportBuilder.Imprimir(FormaResumenBuilder.CalcularResumen(cuadrados), new Ingles());
        ...
        public void TestResumenListaConMasTipos()
        {
            ...
            var resumen = ReportBuilder.Imprimir(FormaResumenBuilder.CalcularResumen(formas), new Ingles());
        ...
        public void TestResumenListaConMasTiposEnCastellano()
        {
            ...
            var resumen = ReportBuilder.Imprimir(FormaResumenBuilder.CalcularResumen(formas), new Castellano());
        ...
        public void TestResumenListaConMasTiposEnItaliano()
        {
            ...
            var resumen = ReportBuilder.Imprimir(FormaResumenBuilder.CalcularResumen(formas), new Italiano());
